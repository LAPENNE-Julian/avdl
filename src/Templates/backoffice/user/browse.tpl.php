    ...
    <?php foreach($users as $user): ?>
      <tr>
        ...
        <td>
          ...
          <a class="btn btn-outline-warning" href="/backoffice/user/edit/<?= htmlentities($user->getId()) ?>" title="Edit" alt="Edit">
          ...
          <div class="btn-group" role="group">
              ...
              <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                  <li><a class="dropdown-item" href="/backoffice/user/delete/<?= htmlentities($user->getId()) ?>">Yes I am sure !</a></li>
                  <li><a class="dropdown-item" href="/backoffice/user">Nope</a></li>
              </ul>
          </div>
