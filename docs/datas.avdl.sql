...
INSERT INTO `user` (`id`,`pseudo`, `email`, `password`, `img`, `roles`, `created_at`, `updated_at`, `is_verified`) VALUES (1, 'admin', 'admin@mail.fr', '$2y$10$Wu9LyPxOlv3dfSlZhDvQLuuu8agIsoG/Y7YQjyXCNctKvOrO4BSXq', DEFAULT, 2, DEFAULT, NULL, 0),
